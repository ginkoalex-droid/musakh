export const ru = {
  ...
  wo_total: 'Всего ЗН',
  wo_closed: 'Закрыто',
  wo_col_closed: 'Закрыт',
  wo_col_time: 'Время',
  wo_search_placeholder: 'Поиск по номеру ЗН, госномеру, марке, модели...',
  wo_by_mechanics: 'По механикам',
  wo_mileage: 'Пробег (км)',
  wo_client_materials: 'Материалы клиента / проходные',
  lbl_selected: 'Выбрано',
  parts_picker_hint: 'Выбери запчасти из списка',
  parts_picker_add: 'Добавить в ЗН',
  wo_no_stock_impact: 'не влияет на склад',
  wo_shirut_label: 'Ширут',
  wo_mileage_ph: '12500',
  wo_client_phone: 'Телефон клиента',
  wo_status_all: 'Все',
  wo_open_included: '+ открытые из других дней',
  wo_reopen_btn: 'Открыть заново',
  wo_reopen_confirm: 'Открыть заново? ЗН снова станет активным.',
  wo_reopened_toast: 'ЗН открыт заново',
  ...
  wo_no_parts_confirm_text: 'Подтверждаю — запчасти не использовались',
  wo_no_parts_btn: 'Закрыть ЗН',
  wo_close_anyway: 'Всё равно закрыть',
  wo_mechanic_label: 'Механик',
  wo_model_label: 'Модель',
  wo_repair_type_label: 'Вид работы',
  wo_edit_mechanics_title: 'Изменить механиков',
  wo_no_second_mech: '— нет —',
  wo_share_label: 'Доля',
  mech_title: 'Механики',
  ...
  issue_type: 'Тип списания',
  issue_type_wo: 'Заказ-наряд',
  issue_type_sale: 'Продажа клиенту',
  issue_type_other: 'Другое',
  issue_customer: 'Покупатель *',
  issue_customer_placeholder: 'Имя клиента...',
  issue_reason: 'Причина *',
  issue_reason_placeholder: 'Причина списания...',
  ...
  mov_to: 'По',
  mov_total: 'Итого',
  mov_summary_total: 'Итого за период',
  ...
  wo_repair_placeholder: 'Замена масла, ТО, ремонт тормозов, диагностика...',
  wo_select_type: '— выбери тип —',
  wo_number_placeholder: 'или сканируй штрихкод',
